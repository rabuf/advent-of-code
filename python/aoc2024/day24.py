...
def dependencies(values):
    ...
    def recur(name, depth=None):
        ...
        return (
            [name]
            + recur(l, depth - 1 if depth else None)
            + recur(r, depth - 1 if depth else None)
        )
    ...
    set(recur("z15")).difference(inputs)
    set(recur("z30")).difference(inputs)
    for xy in inputs:
                    ...
                    match first_wrong(values):
                        case None:
                            ...
                            if many_trials(values):
                                print(
                                    with_x_y(values, x_initial=x, y_initial=y),
                                    x,
                                    y,
                                    x + y,
                                ...
                                names = (
                                    {s for s, _ in swapped}
                                    | {s for _, s in swapped}
                                    | {a, b}
                                )
                                print(swapped | {(a, b)})
