...
* Some helper stuff
This is the runner for the Ada code. I'm keeping it simple, launching
the solvers is handled in the package created for each day. I may add
something smarter to this so that I don't have to run every task in
order to run some, but this will work for now.
