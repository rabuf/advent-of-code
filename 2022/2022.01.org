...
#+BEGIN_SRC ada :tangle ada/aoc2022-day01.ads
  package AOC2022.Day01 is
     procedure Run;
  end AOC2022.Day01;
#+END_SRC
*** Packages
...
#+BEGIN_SRC ada :tangle ada/aoc2022-day01.adb :noweb yes
  <<ada-packages>>
  package body AOC2022.Day01 is
     <<types-and-generics>>
     ...
     procedure Run is
     begin
        Put_Line("Advent of Code 2022 - Day 01");
