...
#+NAME: problem-a
#+BEGIN_SRC lisp :noweb yes :results silent
  (defun problem-a () (format t "Problem 17 A: ~a~%" (parse-clay-coordinates *input*)))
#+END_SRC
** Part 2
#+NAME: problem-b
#+BEGIN_SRC lisp :noweb yes :results silent
  (defun problem-b () (format t "Problem 17 B: ~a~%" (parse-clay-coordinates *input*)))
#+END_SRC
...
#+RESULTS: answers
#+begin_example
Problem 17 A: #S(WATER-TABLES
                 :CLAY #<HASH-TABLE :TEST EQL :COUNT 19171 {100455C9E3}>
                 :WATER #<HASH-TABLE :TEST EQL :COUNT 1 {100455CE03}>
                 :MIN-Y 8
                 :MAX-Y 1780
                 :MIN-X 385
                 :MAX-X 597)
Problem 17 B: #S(WATER-TABLES
                 :CLAY #<HASH-TABLE :TEST EQL :COUNT 19171 {100484F373}>
                 :WATER #<HASH-TABLE :TEST EQL :COUNT 1 {100484F793}>
                 :MIN-Y 8
                 :MAX-Y 1780
                 :MIN-X 385
                 :MAX-X 597)
